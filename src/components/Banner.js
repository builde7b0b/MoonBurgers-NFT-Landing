...
import img2 from '../assets/Nfts/burgs/35.png';
import img3 from '../assets/Nfts/burgs/35.png';
import img4 from '../assets/Nfts/burgs/35.png';
import img5 from '../assets/Nfts/burgs/35.png';
import img6 from '../assets/Nfts/burgs/35.png';
...
const Banner = () => {
  return (
    <Section>
        ...
        <Title>Join the  <br /> MoonBurgers club  </Title>
        <BtnContainer>

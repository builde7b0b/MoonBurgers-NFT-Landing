  ...
  return (
    <Section id="about">
      <Container>
        ...
        <Box> 
        <Title>
        Welcome To The <br /> Buzz Burgers Club.
        </Title>
        <SubText>
        The BUZZ BURGERS CLUB is a private collection of NFTs—unique digital collectibles. The Weirdos are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
        </SubText>
        <SubTextLight>
